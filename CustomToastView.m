...
- (instancetype)initWithTitle:(NSString *)title
                      subtitle:(NSString *)subtitle
                          icon:(UIImage *)icon
                      autoHide:(NSTimeInterval)seconds {
...
- (void)presentToastInViewController:(UIViewController *)viewController {
    ...
    UILayoutGuide *safe = viewController.view.safeAreaLayoutGuide;
    [NSLayoutConstraint activateConstraints:@[
        [self.centerXAnchor constraintEqualToAnchor:viewController.view.centerXAnchor],
        [self.topAnchor constraintEqualToAnchor:safe.topAnchor constant:12],
        [self.leadingAnchor constraintGreaterThanOrEqualToAnchor:safe.leadingAnchor constant:16],
        [self.trailingAnchor constraintLessThanOrEqualToAnchor:safe.trailingAnchor constant:-16],
        [self.widthAnchor constraintLessThanOrEqualToConstant:320],
        [self.widthAnchor constraintGreaterThanOrEqualToConstant:180],
